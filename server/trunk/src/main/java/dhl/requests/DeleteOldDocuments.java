...
public class DeleteOldDocuments {
    public static RequestInternalResult V1(Connection conn) throws AxisFault {
        ...
        // Laeme andmebaasist sõilitustõhtaja õletanud dokumendid
        ...
        for (int i = 0; i < expiredDocuments.size(); ++i) {
            ...
            if (doc.getSendStatusID() == CommonStructures.SendStatus_Sending) {
                ...
                // dokumenile veel N põeva ajapikendust, enne kui see lõplikult
                ...
                // Mõrgime saatmisel olevad adressaadid katkestatuks
                ...
                // Salvestame uue sõilitustõhtaja andmebaasi
    ...
    private static void sendEmail(String toAddress, Date docSendingDate) {
        try {
            if ((Settings.currentProperties != null) && (Settings.currentProperties.getProperty("mail.host") != null)
                ...
                message.setText( "Dokumendivahetuskeskus katkestas Teie poolt "+ docSendingDateString +" saadetud dokumendi edastamise, kuna võhemalt õks adressaat ei ole dokumendi edastustõhtaja jooksul saadetud dokumenti vastu võtnud." );
