...
// X-Tee põise representatsioon koodi tasemel
public final class XHeader
{
    ...
    // Lisab kõesoleva objekti andmed SOAP põisesse
    ...
    public static XHeader getFromSOAPHeaderAxis( org.apache.axis.MessageContext context )
    {
        try
        {
            ...
            org.apache.axis.message.SOAPHeaderElement element = envelope.getHeaderByName("http://x-tee.riik.ee/xsd/xtee.xsd","asutus");
            if( element != null )
            {
