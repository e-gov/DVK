...
CREATE TABLE vastuvotja (
	...
	allyksuse_lyhinimetus varchar(60) NULL,
	ametikoha_lyhinimetus varchar(25) NULL,
	dhx_internal_consignment_id character varying(200),
	dhx_external_consignment_id character varying(200),
	dhx_external_receipt_id character varying(200),
...
COMMENT ON COLUMN asutus.dhx_asutus IS 'kas tegemist on DHX asutusega';
