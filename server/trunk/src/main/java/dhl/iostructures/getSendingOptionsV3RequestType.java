        ...
        if (msgNodes.getLength() > 0) {
            ...
            if (bodyNodes.getLength() > 0) {
                ...
                if (docRefNodes.getLength() > 0) {
                	...
                	throw new Exception("Vigane põringu getSendingOptions.V3 keha - puudub element \"parameetrid\".");
                }                
            } else {
            	throw new Exception("Vigane põringu getSendingOptions.V3 keha - puudub element \"keha\".");
            }
        } else {
        	throw new Exception("Vigane põringu getSendingOptions.V3 keha - puudub element \"getSendingOptions\".");
        }
    }
