...
public class DocumentFragment {
    ...
    public void loadFromDB(int orgID, String deliverySessionID, int fragmentNr, Connection conn) throws AxisFault {    
        try {
            ...
            if (rs.next()) {
                ...
                byte[] containerData = rs.getBytes("sisu");
                CommonMethods.writeToFile(m_fileName, containerData);
    ...
    public int addToDBProc(Connection conn, XRoadHeader xTeePais) throws AxisFault {
        try {
            ...
            if (conn != null) {
                ...
                try {
                    ...
                    String sql = "INSERT INTO dokumendi_fragment("
                            ...
                            + "fragment_nr, fragmente_kokku, loodud, sisu) VALUES(?,?,?,?,?,?,?,?)";
                    ...
                    if (file.exists()) {
                    	...
                    	PreparedStatement ps = conn.prepareStatement("UPDATE dokumendi_fragment SET sisu = ? WHERE fragment_id = ?"); 
    ...
    public static String getFullDocument(int orgID, String deliverySessionID, boolean isIncoming, Connection conn) {
        try {
            if (conn != null) {
                ...
                cs.setInt(2, orgID);
                cs.setString(3, deliverySessionID);
                cs.setInt(4, isIncoming ? 1 : 0);
                ...
                try {
                    while (rs.next()) {
                        byte[] containerData = rs.getBytes("sisu");
                        CommonMethods.writeToFile(resultFile, containerData);
                    }
                } finally {
                    fos.flush();
                    fos.close();
    ...
    public static FragmentationResult getFragments(String fileName, long fragmentMaxSize, int orgID,
                                                   ...
                                                   Connection conn, XRoadHeader xTeePais) throws AxisFault {
