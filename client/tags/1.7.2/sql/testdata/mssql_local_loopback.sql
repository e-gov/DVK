...
select	@org_code = '11111111',
		...
		@unit_id = 0,
		@dvk_folder_name = '/MSSQL';

insert into dhl_settings(id, institution_code, institution_name, personal_id_code, unit_id)
values(1, @org_code, @org_name, @personal_id_code, @unit_id);

insert into dhl_settings_folders(dhl_settings_id, folder_name)
values (1, @dvk_folder_name);
