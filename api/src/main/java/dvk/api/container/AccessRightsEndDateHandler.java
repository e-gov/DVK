...
public class AccessRightsEndDateHandler implements FieldHandler {
    private static final String FORMAT = "yyyy-MM-dd";

    /**
     * Creates a new AccessRightsEndDateHandler instance.
     */
    public AccessRightsEndDateHandler() {
        super();
    }
    ...
    public Object getValue(Object object) throws IllegalStateException {
        ...
        Date value = (Date) accessRights.getEndDate();
        if (value == null) {
            return null;
        }
    ...
    public void setValue(Object object, Object value) throws IllegalStateException, IllegalArgumentException {
        ((AccessRights) object).setEndDate(Util.parseDate((String) value));
    }
    ...
    public void resetValue(Object object) throws IllegalStateException, IllegalArgumentException {
        ((AccessRights) object).setEndDate(null);
    }
