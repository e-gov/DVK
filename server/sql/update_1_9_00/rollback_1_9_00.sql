ALTER TABLE asutus DROP dhx_asutus;
ALTER TABLE vastuvotja DROP dhx_internal_consignment_id;
ALTER TABLE vastuvotja DROP dhx_external_consignment_id;
ALTER TABLE vastuvotja DROP dhx_external_receipt_id;
ALTER TABLE vastuvotja DROP last_send_date;
...
END; $BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION "Add_Vastuvotja"(integer, integer, integer, integer, integer, character varying, character varying, character varying, character varying, character varying, character varying, integer, integer, timestamp without time zone, timestamp without time zone, character varying, character varying, character varying, character varying, integer, text, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying, integer, timestamp without time zone)
  OWNER TO dvk_admin;
...
ALTER TYPE get_asutus_by_id DROP ATTRIBUTE IF EXISTS dhx_asutus;
...
ALTER TYPE get_asutus_by_regnr DROP ATTRIBUTE IF EXISTS dhx_asutus; 
