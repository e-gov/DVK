...
begin
    ...
    (
        ...
        where   t5.transport_id = v5.transport_id
                ...
                and nvl(Get_DocumentsSentTo.division_id, nvl(v5.allyksus_id,0)) = nvl(v5.allyksus_id,0)
                and nvl(Get_DocumentsSentTo.occupation_id, nvl(v5.ametikoht_id,0)) = nvl(v5.ametikoht_id,0)
    ) rights_filter
