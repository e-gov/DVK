...
select	@org_code = '11111111',
		...
		@unit_id = 0,
		@dvk_folder_name = '',
		@subdivision_short_name = 'allyksus',
		@subdivision_name = 'Allüksus';

insert into dhl_settings(id, institution_code, institution_name, personal_id_code, unit_id, subdivision_short_name, subdivision_name)
values(1, @org_code, @org_name, @personal_id_code, @unit_id, @subdivision_short_name, @subdivision_name);
